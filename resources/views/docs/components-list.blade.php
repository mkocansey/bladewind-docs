...
@endphp
<div class="{{ $css }} component-accordion"><div class="dot"></div><a href="/component/accordion">Accordion <x-bladewind::icon name="bolt" type="solid" class="text-pink-600 !size-4" /></a></div>
...
<div class="{{ $css }} component-table"><div class="dot"></div><a href="/component/table">Table <x-bladewind::icon name="bolt" type="solid" class="text-pink-600 !size-4" /></a></div>
