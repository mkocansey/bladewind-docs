...
<div class="{{ $css }} component-chart"><div class="dot"></div><a href="/component/chart">Chart <x-bladewind::icon name="bolt" type="solid" class="text-pink-600 !size-3 ml-1" /></a></div>
<div class="{{ $css }} component-checkbox"><div class="dot"></div><a href="/component/checkbox">Checkbox</a></div>
<div class="{{ $css }} component-checkcard"><div class="dot"></div><a href="/component/checkcard">CheckCard  <x-bladewind::icon name="bolt" type="solid" class="text-pink-600 !size-3 ml-1" /></a></div>
...
<div class="{{ $css }} component-filepicker"><div class="dot"></div><a href="/component/filepicker">Filepicker <x-bladewind::icon name="bolt" type="solid" class="text-pink-600 !size-3 ml-1" /></a></div>
...
<div class="{{ $css }} component-shimmer"><div class="dot"></div><a href="/component/shimmer">Shimmer <x-bladewind::icon name="bolt" type="solid" class="text-pink-600 !size-3 ml-1" /></a></div>
...
<div class="{{ $css }} component-table"><div class="dot"></div><a href="/component/table">Table <x-bladewind::icon name="bolt" type="solid" class="text-pink-600 !size-3" /></a></div>
...
<div class="{{ $css }} component-timepicker"><div class="dot"></div><a href="/component/timepicker">Timepicker <x-bladewind::icon name="bolt" type="solid" class="text-pink-600 !size-3 ml-1" /></a></div>
