<x-app>
    ...
    <x-bladewind::label placeholder="Upload a PDF" name="pdf_only" accepted_file_types=".pdf"  />
    ...
    <x-bladewind::label placeholder="Upload a PDF" name="pdf_only_1mb" accepted_file_types=".pdf" max_file_size="1"  />
