<x-app>
    ...
    @php
        $iconExample1 = <<<'HTML'
            ...
            HTML;
    @endphp
    <x-bladewind::code-block language="markup" line_numbers="true" :code="$iconExample1"></x-bladewind::code-block>
    <p>
    ...
    @php
        $iconExample2 = <<<'HTML'
            ...
            HTML;
    @endphp
    <x-bladewind::code-block language="markup" line_numbers="true" :code="$iconExample2"></x-bladewind::code-block>
    ...
    @php
        $iconExample3 = <<<'HTML'
            ...
            HTML;
    @endphp
    <x-bladewind::code-block language="markup" line_numbers="true" :code="$iconExample3"></x-bladewind::code-block>
    <div class="text-center pt-10">
    ...
    @php
        $iconExample4 = <<<'HTML'
            ...
            HTML;
    @endphp
    <x-bladewind::code-block language="markup" line_numbers="true" :code="$iconExample4"></x-bladewind::code-block>

    <h2 id="solid-icons">Solid Icons</h2>
    <p>
        Icons from Heroicons come in two versions, outline and solid. The BladewindUI Icon component by default uses <code class="inline">outline</code>
    ...
    @php
        $iconExample5 = <<<'HTML'
            ...
            HTML;
    @endphp
    <x-bladewind::code-block language="markup" line_numbers="true" :code="$iconExample5"></x-bladewind::code-block>
    <div class="text-center">
        <x-bladewind::icon name="video-camera-slash" class="!h-16 !w-16 text-amber-500" type="solid" />
    </div>
    @php
        $iconExample6 = <<<'HTML'
            <x-bladewind::icon
            ...
            HTML;
    @endphp
    <x-bladewind::code-block language="markup" line_numbers="true" highlight_lines="3" :code="$iconExample6"></x-bladewind::code-block>
...
<path d="M15.5 22V19" stroke="#292D32" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    @php
        $iconExample7 = <<<'HTML'
            ...
            HTML;
    @endphp
    <x-bladewind::code-block language="markup" line_numbers="true" :code="$iconExample7"></x-bladewind::code-block>
...
<path d="M16.2702 9.10001L14.3002 8.25001C14.1402 8.18001 14.0002 7.97001 14.0002 7.79001V4.79001C14.0002 3.85001 13.3102 2.74001 12.4702 2.31001C12.1702 2.16001 11.8202 2.16001 11.5202 2.31001C10.6802 2.74001 9.99023 3.86001 9.99023 4.80001V7.80001C9.99023 7.98001 9.85023 8.19001 9.69023 8.26001L4.11023 10.67C3.49023 10.92 2.99023 11.69 2.99023 12.36V13.65C2.99023 14.49 3.62023 14.9 4.39023 14.57L9.30023 12.45C9.68023 12.28 10.0002 12.49 10.0002 12.91V15.76C10.0002 15.99 9.87023 16.31 9.71023 16.47L7.44023 18.75C7.20023 18.99 7.09023 19.45 7.20023 19.78L7.64023 21.11C7.82023 21.69 8.48024 21.97 9.02024 21.69L11.3502 19.73C11.7002 19.43 12.2802 19.43 12.6302 19.73L14.9602 21.69C15.5002 21.96 16.1602 21.69 16.3602 21.11L16.8002 19.78C16.9102 19.46 16.8002 18.99 16.5602 18.75L14.2902 16.47C14.1202 16.31 13.9902 15.99 13.9902 15.76V12.91C13.9902 12.49 14.3002 12.29 14.6902 12.45L19.6002 14.57C20.3702 14.9 21.0002 14.49 21.0002 13.65V12.36C21.0002 11.69 20.5002 10.92 19.8802 10.66" stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    @php
        $iconExample8 = <<<'HTML'
            ...
            HTML;
    @endphp
    <x-bladewind::code-block language="markup" line_numbers="true" :code="$iconExample8"></x-bladewind::code-block>
    <p>
        <x-bladewind::alert show_close_icon="false">Note how the name attribute now uses single quotes and not double quotes</x-bladewind::alert>
    </p>
    ...
    @php
        $iconExample9 = <<<'HTML'
            ...
            HTML;
    @endphp
    <x-bladewind::code-block language="markup" :code="$iconExample9"></x-bladewind::code-block>
    <br />
    <p>
        <x-bladewind::alert show_close_icon="false">
    ...
    <div class="text-center">
        <x-bladewind::icon name="message-notif" type="solid" class="!h-24 !w-24 !fill-green-300 !stroke-green-500" />
    </div>
    @php
        $iconExample10 = <<<'HTML'
            <x-bladewind::icon
            ...
            HTML;
    @endphp
    <x-bladewind::code-block language="markup" line_numbers="true" highlight_lines="3" :code="$iconExample10"></x-bladewind::code-block>
    ...
    @php
        $iconExample11 = <<<'HTML'
            ...
            HTML;
    @endphp
    <x-bladewind::code-block language="markup" line_numbers="true" highlight_lines="3" :code="$iconExample11"></x-bladewind::code-block>
    <p>
    ...
    @php
        $iconExample12 = <<<'HTML'
            ...
            HTML;
    @endphp
    <x-bladewind::code-block language="markup" line_numbers="true" :code="$iconExample12"></x-bladewind::code-block>
    <p>
    ...
    @php
        $iconExample13 = <<<'HTML'
            ...
            HTML;
    @endphp
    <x-bladewind::code-block language="markup" line_numbers="true" :code="$iconExample13"></x-bladewind::code-block>
