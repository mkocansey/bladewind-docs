<x-app>
    ...
    <div class="text-center pt-10">
        <x-bladewind::icon name="microphone" class="h-14 w-14 text-white bg-pink-400 p-4 rounded-full cursor-pointer hover:bg-pink-500 hover:p-3" />
    </div>
    <pre class="language-markup line-numbers">
        <code>
            &lt;x-bladewind.icon 
    ...
    <div class="text-center">
        <x-bladewind::icon name='<svg class="h-24 w-24 inline-block" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
