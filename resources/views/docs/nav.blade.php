...
<div class="space-y-3">
    ...
    <div class="flex items-center component-bell"><div class="dot"></div><a href="/component/bell">Bell</a> &nbsp;&nbsp;<x-bladewind::tag label="new" color="orange" class="!px-1.5 !py-0.5 !text-[10px]" shade="dark" /></div>
