<x-app>
    <x-slot name="title">Dropmenu Component</x-slot>
    <h1 class="page-title">Dropmenu</h1>
    ...
    <div class="flex flex-col-reverse sm:flex-row">
        <div class="grow sm:w-3/4">
            ...
            <p>
                <code class="inline">
                &lt;x-bladewind.dropmenu&gt;<br />
                &nbsp;&nbsp;&lt;x-slot name="trigger"&gt;<br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;x-bladewind.button type="secondary"&gt;Actions&lt;/x-bladewind.button&gt;<br />
                &nbsp;&nbsp;&lt;/x-slot&gt;<br />
                 ... <br />
            ...
            <p>&nbsp;</p>
            <h3 class="pb-2 ">Dropmenu with all attributes defined</h3>
