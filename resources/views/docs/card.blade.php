                ...
                <div class="grid grid-cols-2 gap-3">
                    <x-bladewind.card reduce_padding="true">
                        <div class="flex items-center">
                            <div><x-bladewind.avatar url="https://lh3.googleusercontent.com/a-/AOh14GhSotQTt_njzqqq-265MKM5z5iPP9m-_A2myyrGXQ=s288-p-rw-no" /></div>
                    ...
                    <x-bladewind.card reduce_padding="true">
                        <div class="flex items-center">
                            <div><x-bladewind.avatar url="https://pbs.twimg.com/profile_images/1388977302583775237/z5uvkwkT_400x400.jpg" /></div>
                            <div class="grow pl-2 pt-1">
                                <b>Judith Kabukie</b>
