<x-app>
    <x-slot name="title">Toggle Component</x-slot>
    ...
    <div class="flex">
        <div class="grow w-3/4">
                ...
                <pre class="language-markup line-numbers" data-line="3">
                    <code>
                        &lt;x-bladewind.toggle 
                            label="Send me quarterly newsletters"
                            bar="thin"  /&gt;
                    </code><a name="checked"></a>
                </pre>
            </p>
            <p>&nbsp;</p>
            <p><h2>Checked and Disabled</h2></p>
            <p>
            ...
            <p><pre class="language-markup"><code>&lt;x-bladewind.toggle color="orange" /&gt;</code></pre></p><a name="attributes"></a>
            ...
            <p>&nbsp;</p>
            <h3 class="pb-2 ">Toggle with all attributes defined</h3>
            <pre class="language-markup line-numbers">
                <code>
                    &lt;x-bladewind.toggle 
                        color="purple"
