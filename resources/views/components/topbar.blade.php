...
<div class="fixed w-full z-40 py-4 px-6 bg-white/90 dark:shadow-none shadow-2xl shadow-indigo-100 border-b border-slate-300/70 dark:border-dark-600 dark:bg-dark-800/70">
    <div class="max-w-7xl mx-auto">
        <div class="flex items-center justify-between">
            ...
            <div class="flex justify-end items-center space-x-5">
                <span class="sm:block hidden opacity-80 rounded-md tracking-wider text-xs py-1 px-2">{{\Composer\InstalledVersions::getPrettyVersion('mkocansey/bladewind')}}</span>
                <x-bladewind::dropmenu modular="false" icon_right="true">
                    <x-slot:trigger>
                        <x-bladewind::icon name="sun" class="hover:text-slate-600 dark:hover:text-dark-300" />
                    </x-slot:trigger>
                    <x-bladewind::dropmenu-item onclick="addToStorage('theme','dark');document.documentElement.classList.add('dark');" icon="moon">Dark Theme</x-bladewind::dropmenu-item>
                    <x-bladewind::dropmenu-item onclick="addToStorage('theme','light');document.documentElement.classList.remove('dark')" icon="sun">Light Theme</x-bladewind::dropmenu-item>
                    <x-bladewind::dropmenu-item onclick="removeFromStorage('theme');location.reload()" icon="computer-desktop">System Theme</x-bladewind::dropmenu-item>
