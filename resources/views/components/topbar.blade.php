    ...
    <div class="max-w-7xl mx-auto">
        <div class="flex items-center justify-between">
            <div onclick="location.href='/'" class="cursor-pointer flex">
                ...
                <div class="sm:hidden bg-indigo-200 opacity-60 rounded-md tracking-wider text-xs font-semibold text-black absolute left-6 top-12 px-1">{{\Composer\InstalledVersions::getPrettyVersion('mkocansey/bladewind')}}</div>
            </div>
            <div class="text-xs rtl:flex-row-reverse flex items-center space-x-2">
