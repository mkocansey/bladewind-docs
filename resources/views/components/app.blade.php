...
<nav class="w-[280px] z-50 py-6 bg-white/95 border-l border-gray-200 fixed right-0 top-0 h-screen shadow-2xl hidden sm:hidden dark:bg-gray-900 dark:border-gray-800 shadow-blue-300 dark:shadow-orange-900 overflow-y-scroll navigation">
    <div class="text-right cursor-pointer" onclick="javascript:animateCSS('.navigation','slideOutRight').then((message) => { hide('.navigation'); });">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 inline mr-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <div class="">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex justify-end items-center space-x-5">
                            ...
                            <a href="#" onclick="animateCSS('.navigation','slideInRight');" class="ml-6 block text-slate-400 hover:text-slate-500 dark:hover:text-slate-300 md:hidden"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
  <path stroke-linecap="round" stroke-linejoin="round" d="M4 6h16M4 12h16M4 18h16" /></svg></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="md:h-20 h-14"></div>
        <div class="md:max-w-7xl mx-auto pt-14">
