            ...
            <div class="">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex justify-end items-center space-x-5">
                        ...
                        <span class="sm:block hidden bg-purple-200 opacity-60 rounded-md tracking-wider text-xs py-1 px-2 font-semibold text-black">{{\Composer\InstalledVersions::getPrettyVersion('mkocansey/bladewind')}}</span>
                    </div>
                </div>
            </div>
        </div>
